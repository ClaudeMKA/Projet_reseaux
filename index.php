...
<section class="about" id="abt">
    <div class="about-container">
        ...
        <div class="about-items">
            ...
            <p>LinkNetwork a été fondée en 2010 par un groupe d'experts en analyse de réseau. Depuis, nous avons acquis une solide réputation en tant que spécialistes de l'analyse de réseau et avons accompagné de nombreuses entreprises pour optimiser la performance et la sécurité de leurs réseaux.<a href="#"> En savoir plus...</a></p>
        </div>
    </div>
</section>
...
<section class="services">
    <div class="services-container">
        <div class="services-items">
            ...
            <button class="btn-services">Voir tous nos services</button>
        </div>
        <div class="services-items">
